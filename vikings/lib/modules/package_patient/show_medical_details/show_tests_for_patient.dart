...
class ShowTestsForPatient extends StatelessWidget {
  const ShowTestsForPatient({Key? key}) : super(key: key);
  @override
            ...
            Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (con) => FullScreenImage(
                          path:
                              'https://192.168.1.11:44314/Medical_Test_Result/${OurCubit.get(context).showAllTests[index]['testResult']}',
                        )));
          },
          child: Center(
            child: Stack(
              children: [
                ...
                Visibility(
                  visible: OurCubit.get(context).isEditTestResult,
                  child: IconButton(
                      onPressed: () {
                        showDialog(
                          context: context,
