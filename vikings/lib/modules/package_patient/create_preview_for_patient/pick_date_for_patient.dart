...
class PickDateForPatient extends StatelessWidget {
  PickDateForPatient({Key? key}) : super(key: key);
                        ...
                        onTap: () {
                          showDatePicker(
                            ...
                            OurCubit.get(context).dateOfPreview = value!;
                             DateContorller.text =DateFormat.yMMMd('ar').format(value);
                            if (formKey.currentState!.validate()) {
                              OurCubit.get(context).avalibaleTimeForPreview = {};
                              OurCubit.get(context).selectedTimeForPreview =
                                  null;
                              await OurCubit.get(context).validatePreviewDateForPatient(
                                    ...
                                    child: DropdownButton2<String>(
                                      ...
                                      onChanged: (value) async {
                                        ...
                                        await OurCubit.get(context)
                                            .validateTimeForPatientPreveiws(
                                          fullDate,
                                          paId!,
                                        );
                                      },
