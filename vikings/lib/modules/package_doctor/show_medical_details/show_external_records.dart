...
class ShowExternalRecordsForDoctor extends StatelessWidget {
  const ShowExternalRecordsForDoctor({Key? key}) : super(key: key);
  @override
    ...
    return BlocConsumer<OurCubit, OurStates>(
      ...
      builder: (context, state) => Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          mini: false,
          onPressed: () {
            Navigator.of(context).pushNamed('/UploadExternalRecord');
          },
