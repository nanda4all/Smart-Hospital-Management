...
using LastHMS2.Data;
using LastHMS2.Timing_Operations;
...
namespace LastHMS2
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            //RecurringJob.AddOrUpdate(() => Operations.EmptySurgeryRooms()
            //, Cron.Minutely);
            //RecurringJob.AddOrUpdate(() => Operations.AlterPreviews()
            //, Cron.Daily);   
            RecurringJob.AddOrUpdate(() => Operations.DeleteAcceptedRequests()
            , Cron.Monthly);
