...
namespace LastHMS2.Migrations
{
    ...
    [Migration("20220218152634_AddAdminsTable")]
            ...
            modelBuilder.Entity("LastHMS2.Models.Doctor", b =>
                {
                    ...
                    b.Property<int>("Doctor_Specialization_Id")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Doctor_Specialization_Id");
            ...
            modelBuilder.Entity("LastHMS2.Models.Doctor", b =>
                {
                    ...
                    b.HasOne("LastHMS2.Extra_Tables.Specialization", null)
                        .WithMany("Doctors")
                        .HasForeignKey("Doctor_Specialization_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("LastHMS2.Models.Hospital", b =>
                {
                    ...
                    b.HasOne("LastHMS2.Models.Doctor", "Manager")
                        .WithMany()
