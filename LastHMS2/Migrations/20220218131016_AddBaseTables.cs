        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Doctor_Birth_Date = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Doctor_Hire_Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Active = table.Column<bool>(type: "bit", nullable: false),
                    Doctor_Birth_Place = table.Column<int>(type: "int", nullable: true),
                    Doctor_Specialization_Id = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Doctor_Id",
                        onDelete: ReferentialAction.NoAction);
                    table.UniqueConstraint("Hospitals_Mgr_Id_Unique", x => x.Mgr_Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Employee_Birth_Date = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Employee_Hire_Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Active = table.Column<bool>(type: "bit", nullable: true),
                    Area_Id = table.Column<int>(type: "int", nullable: false),
                    Employee_Birth_Place = table.Column<int?>(type: "int", nullable: true),
                    Ho_Id = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.Employee_Birth_Place,
                        principalTable: "Cities",
                        principalColumn: "City_Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Patient_Birth_Date = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Active = table.Column<bool>(type: "bit", nullable: true),
                    Area_Id = table.Column<int>(type: "int", nullable: false),
                    Patient_Birth_Place = table.Column<int?>(type: "int", nullable: true),
                    Ho_Id = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.Patient_Birth_Place,
                        principalTable: "Cities",
                        principalColumn: "City_Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
